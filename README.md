...
<br>
  ...
  Software engineer and data scientist, with a passion for graphics. Leveraging a diverse skillset with proficiency in JavaScript, Python, TypeScript, C#, C++, Unity, Unreal, and graphics libraries like SDL and frameworks and libraries like NOdeJS, Express JS, and React amongst others., to create innovative interactive experiences.
